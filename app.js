...
/* =======================================================================
   FIREBASE SETUP
   ---------------------------------------------------------------------
   1. Go to https://firebase.google.com -> Add Project -> create a project
   ...
   3. Click the gear icon -> Project settings -> scroll to "Your apps"
      -> click the </> (Web) icon -> register an app -> copy the config
   4. Paste your config values below, replacing the placeholder text.
   ======================================================================= */
const firebaseConfig = {
  apiKey: "AIzaSyAUEZTWbBxl1-1uDapWZuuKDtTmIo-i0ks",
  authDomain: "gyan-dayini-bal-mandir.firebaseapp.com",
  projectId: "gyan-dayini-bal-mandir",
  storageBucket: "gyan-dayini-bal-mandir.firebasestorage.app",
  messagingSenderId: "615950899981",
  appId: "1:615950899981:web:e2179608ad02ed8b23ee44"
};
const SCHOOL_NAME = "Gyan Dayini Bal Mandir";
const LOGO_DATA_URI = "data:image/png;base64,";
let db = null;
...
try{
  if(firebaseConfig.apiKey && firebaseConfig.apiKey !== "YOUR_API_KEY"){
    // Guard against double-initialization (e.g. if a script tag ever loads twice).
    if(!firebase.apps.length){
      firebase.initializeApp(firebaseConfig);
    }
    firestoreDb = firebase.firestore();
    // Note: offline persistence (enablePersistence) was tried here previously but
    // caused "Failed to obtain primary lease" errors on some devices/browsers,
    // which could crash app startup. It has been removed for stability — the app
    // still works offline via its own retry/timeout logic below (see loadData),
    // it just won't cache Firestore data locally between full app restarts while offline.
    firebaseReady = true;
  }
}catch(e){
...
function buildUpiLink(amount, note){
  const upiId = db.settings && db.settings.upiId;
  if(!upiId || amount<=0) return null;
  return `upi://pay?pa=${encodeURIComponent(upiId)}&pn=${encodeURIComponent(SCHOOL_NAME)}&am=${amount}&cu=INR&tn=${encodeURIComponent(note)}`;
}
function buildFeeReminderMessage(name, cls, bal, dueDate){
  const s = db.settings;
  const upiLink = buildUpiLink(bal, `Fee for ${name} ${cls}`);
  let msg = `Dear Parent, this is a fee reminder from ${SCHOOL_NAME} for ${name} (Class ${cls}). Balance due: ₹${bal.toLocaleString('en-IN')}, due by ${fmtDate(dueDate)}.`;
  if(upiLink) msg += `\n\nPay instantly via UPI: ${upiLink}`;
  if(s.upiId) msg += `\nUPI ID: ${s.upiId}`;
  if(s.bankAccount) msg += `\nAccount No.: ${s.bankAccount}${s.ifsc ? ' | IFSC: '+s.ifsc : ''}${s.bankName ? ' | '+s.bankName : ''}`;
  msg += `\n\nPlease pay at the earliest. - Principal, Mr. Arun Mishra`;
  return msg;
}
...
function defaultData(){
  return {
    settings: { whatsapp: "", subjects: ["Hindi","English","Maths","Science","Social Science"], upiId: "", bankAccount: "", ifsc: "", bankName: "", qrImage: null, currentSession: "2026-27", feeStructure: {} },
    users: [
      {u:"admin", p:"admin123", name:"School Admin", role:"Administrator", status:"Active", assignedClass:null},
      {u:"principal", p:"prin@2026", name:"Anita Verma", role:"Principal", status:"Active", assignedClass:null},
      {u:"teacher1", p:"teach@01", name:"Suresh Yadav", role:"Teacher", status:"Active", assignedClass:"10"},
      {u:"accounts", p:"fees@2026", name:"Neha Gupta", role:"Accountant", status:"Active", assignedClass:null},
    ],
    students: [
      {id:"STU001", name:"Aarav Sharma", cls:"10", sec:"A", roll:1, gender:"Male", dob:"12-Apr-2011", father:"Rajesh Sharma", contact:"9876543210", address:"Semrauta, Tiloi, Amethi", admissionDate:"2020-06-01"},
      {id:"STU002", name:"Ishita Verma", cls:"10", sec:"A", roll:2, gender:"Female", dob:"23-Jul-2011", father:"Manoj Verma", contact:"9876543211", address:"Tiloi, Amethi", admissionDate:"2020-06-01"},
      {id:"STU003", name:"Kabir Singh", cls:"9", sec:"B", roll:1, gender:"Male", dob:"15-Jan-2012", father:"Harpreet Singh", contact:"9876543212", address:"Semrauta, Amethi", admissionDate:"2021-06-01"},
      {id:"STU004", name:"Diya Patel", cls:"9", sec:"B", roll:2, gender:"Female", dob:"30-Mar-2012", father:"Kiran Patel", contact:"9876543213", address:"Tiloi, Amethi", admissionDate:"2021-06-01"},
      {id:"STU005", name:"Vivaan Reddy", cls:"8", sec:"A", roll:1, gender:"Male", dob:"05-Sep-2013", father:"Suresh Reddy", contact:"9876543214", address:"Semrauta, Tiloi, Amethi", admissionDate:"2022-06-01"},
    ],
    alumni: [],
    homework: [],
    staff: [
      {id:"STF001", name:"Suresh Yadav", desig:"Teacher", dept:"Mathematics", contact:"9988776655", email:"suresh.y@school.edu", eligibility:"B.Sc, B.Ed", bankAccount:"1234567890", ifsc:"SBIN0001234", bankName:"State Bank of India"},
...
async function loadData(){
  ...
  try{
    ...
    const timeoutPromise = new Promise((_, reject)=> setTimeout(()=>reject(Object.assign(new Error('timeout'), {code:'timeout'})), 12000));
    const [studentsSnap, staffSnap, feesSnap, annSnap, usersSnap, examsSnap, salarySnap, busSnap, transAssignSnap, alumniSnap, homeworkSnap, settingsDoc, sAttSnap, tAttSnap] = await Promise.race([fetchPromise, timeoutPromise]);
    ...
    if(e && e.code === 'permission-denied'){
      showBanner("⚠ Firebase is blocking access (permission denied) — your Firestore security rules likely need updating (test mode may have expired). Ask Claude for the rules.", "");
    } else if(e && e.code === 'timeout'){
      showBanner("⚠ Connection is slow or unavailable — working offline for now. Data will sync once your connection improves.", "info");
    } else {
...
function migrateData(){
 try{
  ...
  console.error("migrateData error (non-fatal, continuing):", e);
 }
}
...
function updateOnlineStatus(){
  ...
  if(navigator.onLine){
    ...
    txt.textContent = 'Offline — changes won\'t save until reconnected';
  }
}
