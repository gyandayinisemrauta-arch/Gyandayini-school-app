...
const firebaseConfig = {
  apiKey: "AIzaSyAemNc3V-JkAleDXobYZ5W9pBqhzyDHVkM",
  authDomain: "gyandayini-school-app.firebaseapp.com",
  projectId: "gyandayini-school-app",
  storageBucket: "gyandayini-school-app.firebasestorage.app",
  messagingSenderId: "462300469205",
  appId: "1:462300469205:web:cf06c9d13d69e35b5f8f5c"
};
...
try{
  if(firebaseConfig.apiKey && firebaseConfig.apiKey !== "YOUR_API_KEY"){
    ...
    firebaseReady = true;
    // Enable offline persistence: caches data locally and auto-syncs any
    // changes made while offline as soon as the connection comes back.
    firestoreDb.enablePersistence({ synchronizeTabs: true }).catch(err=>{
      // Common reasons this can fail: multiple tabs open (fine, one tab
      // will still have persistence) or an old/unsupported browser.
